...
import { useEditProduct } from '../hooks/useInventoryMutations';
...
const EditProduct: React.FC = () => {
    ...
    const { data: product, isLoading } = useInventoryById(id || '');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await editProductMutation.mutateAsync({ productId: id, productData });
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring-black ${errors.id ? 'border-red-300' : ''
                                    }`}
                            />
                        ...
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring-black ${errors.title ? 'border-red-300' : ''
                                    }`}
                            />
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea
                                ...
                                className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring-black ${errors.description ? 'border-red-300' : ''
                                    }`}
                            />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                placeholder="0.00"
                                className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring-black ${errors.price ? 'border-red-300' : ''
                                    }`}
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                placeholder="1"
                                className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring-black ${errors.inStock ? 'border-red-300' : ''
                                    }`}
                            />
